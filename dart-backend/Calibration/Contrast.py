...
def BrightnessContrast(brightness=0):
    ...
    effect = applyContrast(img, brightness,
                        contrast)
...
def applyContrast(img, brightness=255,
               contrast=127):
...
def adjustContrast(image):
    ...
    result = BrightnessContrast(0)
    return result

if __name__ == '__main__':
    # The function imread loads an image
    # from the specified file and returns it.
    original = cv2.imread("Calibration_standard_output/calibrationData_R.jpg")
